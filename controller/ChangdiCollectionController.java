    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(changdiCollection !=null){
            ...
            BeanUtils.copyProperties( changdiCollection , view );//把实体数据重构到view中
                ...
                //级联表
                HuiyuanEntity huiyuan = huiyuanService.selectById(changdiCollection.getHuiyuanId());
                if(huiyuan != null){
    ...
    */
    ...
    public R save(@RequestBody ChangdiCollectionEntity changdiCollection, HttpServletRequest request){
        ...
        if(false)
            ...
            changdiCollection.setHuiyuanId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<ChangdiCollectionEntity> queryWrapper = new EntityWrapper<ChangdiCollectionEntity>()
            ...
            .eq("huiyuan_id", changdiCollection.getHuiyuanId())
...
//                            changdiCollectionEntity.setHuiyuanId(Integer.valueOf(data.get(0)));   //会员 要改的
