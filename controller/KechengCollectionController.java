    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(kechengCollection !=null){
            ...
            BeanUtils.copyProperties( kechengCollection , view );//把实体数据重构到view中
                ...
                //级联表
                HuiyuanEntity huiyuan = huiyuanService.selectById(kechengCollection.getHuiyuanId());
                if(huiyuan != null){
    ...
    */
    ...
    public R save(@RequestBody KechengCollectionEntity kechengCollection, HttpServletRequest request){
        ...
        if(false)
            ...
            kechengCollection.setHuiyuanId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<KechengCollectionEntity> queryWrapper = new EntityWrapper<KechengCollectionEntity>()
            ...
            .eq("huiyuan_id", kechengCollection.getHuiyuanId())
...
//                            kechengCollectionEntity.setHuiyuanId(Integer.valueOf(data.get(0)));   //会员 要改的
