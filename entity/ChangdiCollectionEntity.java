...
public class ChangdiCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ChangdiCollectionEntity() {

	}

	public ChangdiCollectionEntity(T t) {
		try {
    ...
    public String toString() {
        return "ChangdiCollection{" +
            "id=" + id +
            ", changdiId=" + changdiId +
            ", huiyuanId=" + huiyuanId +
            ", changdiCollectionTypes=" + changdiCollectionTypes +
